...
int trace_ctx_Sequence_Check(HPyContext *tctx, HPy h);
...
HPy trace_ctx_MaybeGetAttr_s(HPyContext *tctx, HPy obj, const char *name);
...
HPy trace_ctx_SeqIter_New(HPyContext *tctx, HPy seq);
...
HPy trace_ctx_Unicode_Substring(HPyContext *tctx, HPy obj, HPy_ssize_t start, HPy_ssize_t end);
...
int trace_ctx_ContextVar_Get(HPyContext *tctx, HPy context_var, HPy default_value, HPy *result);
...
static inline void trace_ctx_init_fields(HPyContext *tctx, HPyContext *uctx)
{
    ...
    tctx->ctx_Long_FromLong = &trace_ctx_Long_FromLong;
    tctx->ctx_Long_FromUnsignedLong = &trace_ctx_Long_FromUnsignedLong;
    tctx->ctx_Long_FromLongLong = &trace_ctx_Long_FromLongLong;
    tctx->ctx_Long_FromUnsignedLongLong = &trace_ctx_Long_FromUnsignedLongLong;
    tctx->ctx_Long_FromSize_t = &trace_ctx_Long_FromSize_t;
    tctx->ctx_Long_FromSsize_t = &trace_ctx_Long_FromSsize_t;
    tctx->ctx_Long_AsLong = &trace_ctx_Long_AsLong;
    tctx->ctx_Long_AsUnsignedLong = &trace_ctx_Long_AsUnsignedLong;
    tctx->ctx_Long_AsUnsignedLongMask = &trace_ctx_Long_AsUnsignedLongMask;
    tctx->ctx_Long_AsLongLong = &trace_ctx_Long_AsLongLong;
    tctx->ctx_Long_AsUnsignedLongLong = &trace_ctx_Long_AsUnsignedLongLong;
    tctx->ctx_Long_AsUnsignedLongLongMask = &trace_ctx_Long_AsUnsignedLongLongMask;
    ...
    tctx->ctx_Sequence_Check = &trace_ctx_Sequence_Check;
    ...
    tctx->ctx_MaybeGetAttr_s = &trace_ctx_MaybeGetAttr_s;
    ...
    tctx->ctx_SeqIter_New = &trace_ctx_SeqIter_New;
