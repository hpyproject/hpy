...
def __bootstrap__():
    ...
    if version_info < (3, 10):
        # there is a bug in importlib.resources that doesn't handle namespace package
        # and also pkg_resources is available, so just use pkg_resources.
        from pkg_resources import resource_filename

        ext_filepath = resource_filename(__name__, ext_name)
