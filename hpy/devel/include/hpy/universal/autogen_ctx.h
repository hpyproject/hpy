...
struct _HPyContext_s {
    ...
    HPy (*ctx_Long_FromInt32)(HPyContext *ctx, int32_t value);
    HPy (*ctx_Long_FromUInt32)(HPyContext *ctx, uint32_t value);
    HPy (*ctx_Long_FromInt64)(HPyContext *ctx, int64_t v);
    HPy (*ctx_Long_FromUInt64)(HPyContext *ctx, uint64_t v);
    HPy (*ctx_Long_FromSize_t)(HPyContext *ctx, size_t value);
    HPy (*ctx_Long_FromSsize_t)(HPyContext *ctx, HPy_ssize_t value);
    int32_t (*ctx_Long_AsInt32)(HPyContext *ctx, HPy h);
    uint32_t (*ctx_Long_AsUInt32)(HPyContext *ctx, HPy h);
    uint32_t (*ctx_Long_AsUInt32Mask)(HPyContext *ctx, HPy h);
    int64_t (*ctx_Long_AsInt64)(HPyContext *ctx, HPy h);
    uint64_t (*ctx_Long_AsUInt64)(HPyContext *ctx, HPy h);
    uint64_t (*ctx_Long_AsUInt64Mask)(HPyContext *ctx, HPy h);
