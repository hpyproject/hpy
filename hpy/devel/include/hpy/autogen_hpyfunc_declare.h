...
#define _HPyFunc_DECLARE_HPyFunc_TRAVERSEPROC(SYM) static int SYM(HPyContext *ctx, HPy self, HPyFunc_visitproc visit, void *arg)
...
typedef int (*HPyFunc_traverseproc)(HPyContext *ctx, HPy self, HPyFunc_visitproc visit, void *arg);
