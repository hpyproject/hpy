...
struct _HPyContext_s {
    ...
    struct _object *(*ctx_CallRealFunctionWithKeywordsFromTrampoline)(HPyContext ctx, struct _object *self, struct _object *args, struct _object *kw, void *func, int ml_flags);
};
