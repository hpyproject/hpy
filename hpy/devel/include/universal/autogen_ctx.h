...
struct _HPyContext_s {
    ...
    HPy (*ctx_Number_Subtract)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_Multiply)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_MatrixMultiply)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_FloorDivide)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_TrueDivide)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_Remainder)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_Divmod)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_Power)(HPyContext ctx, HPy h1, HPy h2, HPy h3);
    HPy (*ctx_Number_Negative)(HPyContext ctx, HPy h1);
    HPy (*ctx_Number_Positive)(HPyContext ctx, HPy h1);
    HPy (*ctx_Number_Absolute)(HPyContext ctx, HPy h1);
    HPy (*ctx_Number_Invert)(HPyContext ctx, HPy h1);
    HPy (*ctx_Number_Lshift)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_Rshift)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_And)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_Xor)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_Or)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_Index)(HPyContext ctx, HPy h1);
    HPy (*ctx_Number_Long)(HPyContext ctx, HPy h1);
    HPy (*ctx_Number_Float)(HPyContext ctx, HPy h1);
    HPy (*ctx_Number_InPlaceAdd)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_InPlaceSubtract)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_InPlaceMultiply)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_InPlaceMatrixMultiply)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_InPlaceFloorDivide)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_InPlaceTrueDivide)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_InPlaceRemainder)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_InPlacePower)(HPyContext ctx, HPy h1, HPy h2, HPy h3);
    HPy (*ctx_Number_InPlaceLshift)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_InPlaceRshift)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_InPlaceAnd)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_InPlaceXor)(HPyContext ctx, HPy h1, HPy h2);
    HPy (*ctx_Number_InPlaceOr)(HPyContext ctx, HPy h1, HPy h2);
