...
static inline void debug_init_prebuilt_handles(HPyContext ctx, HPyContext uctx)
{
    ctx->h_None = DHPy_wrap(ctx, uctx->h_None);
    ctx->h_True = DHPy_wrap(ctx, uctx->h_True);
    ctx->h_False = DHPy_wrap(ctx, uctx->h_False);
    ctx->h_BaseException = DHPy_wrap(ctx, uctx->h_BaseException);
    ctx->h_Exception = DHPy_wrap(ctx, uctx->h_Exception);
    ctx->h_StopAsyncIteration = DHPy_wrap(ctx, uctx->h_StopAsyncIteration);
    ctx->h_StopIteration = DHPy_wrap(ctx, uctx->h_StopIteration);
    ctx->h_GeneratorExit = DHPy_wrap(ctx, uctx->h_GeneratorExit);
    ctx->h_ArithmeticError = DHPy_wrap(ctx, uctx->h_ArithmeticError);
    ctx->h_LookupError = DHPy_wrap(ctx, uctx->h_LookupError);
    ctx->h_AssertionError = DHPy_wrap(ctx, uctx->h_AssertionError);
    ctx->h_AttributeError = DHPy_wrap(ctx, uctx->h_AttributeError);
    ctx->h_BufferError = DHPy_wrap(ctx, uctx->h_BufferError);
    ctx->h_EOFError = DHPy_wrap(ctx, uctx->h_EOFError);
    ctx->h_FloatingPointError = DHPy_wrap(ctx, uctx->h_FloatingPointError);
    ctx->h_OSError = DHPy_wrap(ctx, uctx->h_OSError);
    ctx->h_ImportError = DHPy_wrap(ctx, uctx->h_ImportError);
    ctx->h_ModuleNotFoundError = DHPy_wrap(ctx, uctx->h_ModuleNotFoundError);
    ctx->h_IndexError = DHPy_wrap(ctx, uctx->h_IndexError);
    ctx->h_KeyError = DHPy_wrap(ctx, uctx->h_KeyError);
    ctx->h_KeyboardInterrupt = DHPy_wrap(ctx, uctx->h_KeyboardInterrupt);
    ctx->h_MemoryError = DHPy_wrap(ctx, uctx->h_MemoryError);
    ctx->h_NameError = DHPy_wrap(ctx, uctx->h_NameError);
    ctx->h_OverflowError = DHPy_wrap(ctx, uctx->h_OverflowError);
    ctx->h_RuntimeError = DHPy_wrap(ctx, uctx->h_RuntimeError);
    ctx->h_RecursionError = DHPy_wrap(ctx, uctx->h_RecursionError);
    ctx->h_NotImplementedError = DHPy_wrap(ctx, uctx->h_NotImplementedError);
    ctx->h_SyntaxError = DHPy_wrap(ctx, uctx->h_SyntaxError);
    ctx->h_IndentationError = DHPy_wrap(ctx, uctx->h_IndentationError);
    ctx->h_TabError = DHPy_wrap(ctx, uctx->h_TabError);
    ctx->h_ReferenceError = DHPy_wrap(ctx, uctx->h_ReferenceError);
    ctx->h_SystemError = DHPy_wrap(ctx, uctx->h_SystemError);
    ctx->h_SystemExit = DHPy_wrap(ctx, uctx->h_SystemExit);
    ctx->h_TypeError = DHPy_wrap(ctx, uctx->h_TypeError);
    ctx->h_UnboundLocalError = DHPy_wrap(ctx, uctx->h_UnboundLocalError);
    ctx->h_UnicodeError = DHPy_wrap(ctx, uctx->h_UnicodeError);
    ctx->h_UnicodeEncodeError = DHPy_wrap(ctx, uctx->h_UnicodeEncodeError);
    ctx->h_UnicodeDecodeError = DHPy_wrap(ctx, uctx->h_UnicodeDecodeError);
    ctx->h_UnicodeTranslateError = DHPy_wrap(ctx, uctx->h_UnicodeTranslateError);
    ctx->h_ValueError = DHPy_wrap(ctx, uctx->h_ValueError);
    ctx->h_ZeroDivisionError = DHPy_wrap(ctx, uctx->h_ZeroDivisionError);
    ctx->h_BlockingIOError = DHPy_wrap(ctx, uctx->h_BlockingIOError);
    ctx->h_BrokenPipeError = DHPy_wrap(ctx, uctx->h_BrokenPipeError);
    ctx->h_ChildProcessError = DHPy_wrap(ctx, uctx->h_ChildProcessError);
    ctx->h_ConnectionError = DHPy_wrap(ctx, uctx->h_ConnectionError);
    ctx->h_ConnectionAbortedError = DHPy_wrap(ctx, uctx->h_ConnectionAbortedError);
    ctx->h_ConnectionRefusedError = DHPy_wrap(ctx, uctx->h_ConnectionRefusedError);
    ctx->h_ConnectionResetError = DHPy_wrap(ctx, uctx->h_ConnectionResetError);
    ctx->h_FileExistsError = DHPy_wrap(ctx, uctx->h_FileExistsError);
    ctx->h_FileNotFoundError = DHPy_wrap(ctx, uctx->h_FileNotFoundError);
    ctx->h_InterruptedError = DHPy_wrap(ctx, uctx->h_InterruptedError);
    ctx->h_IsADirectoryError = DHPy_wrap(ctx, uctx->h_IsADirectoryError);
    ctx->h_NotADirectoryError = DHPy_wrap(ctx, uctx->h_NotADirectoryError);
    ctx->h_PermissionError = DHPy_wrap(ctx, uctx->h_PermissionError);
    ctx->h_ProcessLookupError = DHPy_wrap(ctx, uctx->h_ProcessLookupError);
    ctx->h_TimeoutError = DHPy_wrap(ctx, uctx->h_TimeoutError);
    ctx->h_Warning = DHPy_wrap(ctx, uctx->h_Warning);
    ctx->h_UserWarning = DHPy_wrap(ctx, uctx->h_UserWarning);
    ctx->h_DeprecationWarning = DHPy_wrap(ctx, uctx->h_DeprecationWarning);
    ctx->h_PendingDeprecationWarning = DHPy_wrap(ctx, uctx->h_PendingDeprecationWarning);
    ctx->h_SyntaxWarning = DHPy_wrap(ctx, uctx->h_SyntaxWarning);
    ctx->h_RuntimeWarning = DHPy_wrap(ctx, uctx->h_RuntimeWarning);
    ctx->h_FutureWarning = DHPy_wrap(ctx, uctx->h_FutureWarning);
    ctx->h_ImportWarning = DHPy_wrap(ctx, uctx->h_ImportWarning);
    ctx->h_UnicodeWarning = DHPy_wrap(ctx, uctx->h_UnicodeWarning);
    ctx->h_BytesWarning = DHPy_wrap(ctx, uctx->h_BytesWarning);
    ctx->h_ResourceWarning = DHPy_wrap(ctx, uctx->h_ResourceWarning);
    ctx->h_BaseObjectType = DHPy_wrap(ctx, uctx->h_BaseObjectType);
    ctx->h_TypeType = DHPy_wrap(ctx, uctx->h_TypeType);
    ctx->h_LongType = DHPy_wrap(ctx, uctx->h_LongType);
    ctx->h_UnicodeType = DHPy_wrap(ctx, uctx->h_UnicodeType);
    ctx->h_TupleType = DHPy_wrap(ctx, uctx->h_TupleType);
