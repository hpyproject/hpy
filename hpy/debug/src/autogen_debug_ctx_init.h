...
{
    dctx->h_None = DHPy_open_context_constant(dctx, uctx->h_None);
    dctx->h_True = DHPy_open_context_constant(dctx, uctx->h_True);
    dctx->h_False = DHPy_open_context_constant(dctx, uctx->h_False);
    dctx->h_NotImplemented = DHPy_open_context_constant(dctx, uctx->h_NotImplemented);
    dctx->h_Ellipsis = DHPy_open_context_constant(dctx, uctx->h_Ellipsis);
    dctx->h_BaseException = DHPy_open_context_constant(dctx, uctx->h_BaseException);
    dctx->h_Exception = DHPy_open_context_constant(dctx, uctx->h_Exception);
    dctx->h_StopAsyncIteration = DHPy_open_context_constant(dctx, uctx->h_StopAsyncIteration);
    dctx->h_StopIteration = DHPy_open_context_constant(dctx, uctx->h_StopIteration);
    dctx->h_GeneratorExit = DHPy_open_context_constant(dctx, uctx->h_GeneratorExit);
    dctx->h_ArithmeticError = DHPy_open_context_constant(dctx, uctx->h_ArithmeticError);
    dctx->h_LookupError = DHPy_open_context_constant(dctx, uctx->h_LookupError);
    dctx->h_AssertionError = DHPy_open_context_constant(dctx, uctx->h_AssertionError);
    dctx->h_AttributeError = DHPy_open_context_constant(dctx, uctx->h_AttributeError);
    dctx->h_BufferError = DHPy_open_context_constant(dctx, uctx->h_BufferError);
    dctx->h_EOFError = DHPy_open_context_constant(dctx, uctx->h_EOFError);
    dctx->h_FloatingPointError = DHPy_open_context_constant(dctx, uctx->h_FloatingPointError);
    dctx->h_OSError = DHPy_open_context_constant(dctx, uctx->h_OSError);
    dctx->h_ImportError = DHPy_open_context_constant(dctx, uctx->h_ImportError);
    dctx->h_ModuleNotFoundError = DHPy_open_context_constant(dctx, uctx->h_ModuleNotFoundError);
    dctx->h_IndexError = DHPy_open_context_constant(dctx, uctx->h_IndexError);
    dctx->h_KeyError = DHPy_open_context_constant(dctx, uctx->h_KeyError);
    dctx->h_KeyboardInterrupt = DHPy_open_context_constant(dctx, uctx->h_KeyboardInterrupt);
    dctx->h_MemoryError = DHPy_open_context_constant(dctx, uctx->h_MemoryError);
    dctx->h_NameError = DHPy_open_context_constant(dctx, uctx->h_NameError);
    dctx->h_OverflowError = DHPy_open_context_constant(dctx, uctx->h_OverflowError);
    dctx->h_RuntimeError = DHPy_open_context_constant(dctx, uctx->h_RuntimeError);
    dctx->h_RecursionError = DHPy_open_context_constant(dctx, uctx->h_RecursionError);
    dctx->h_NotImplementedError = DHPy_open_context_constant(dctx, uctx->h_NotImplementedError);
    dctx->h_SyntaxError = DHPy_open_context_constant(dctx, uctx->h_SyntaxError);
    dctx->h_IndentationError = DHPy_open_context_constant(dctx, uctx->h_IndentationError);
    dctx->h_TabError = DHPy_open_context_constant(dctx, uctx->h_TabError);
    dctx->h_ReferenceError = DHPy_open_context_constant(dctx, uctx->h_ReferenceError);
    dctx->h_SystemError = DHPy_open_context_constant(dctx, uctx->h_SystemError);
    dctx->h_SystemExit = DHPy_open_context_constant(dctx, uctx->h_SystemExit);
    dctx->h_TypeError = DHPy_open_context_constant(dctx, uctx->h_TypeError);
    dctx->h_UnboundLocalError = DHPy_open_context_constant(dctx, uctx->h_UnboundLocalError);
    dctx->h_UnicodeError = DHPy_open_context_constant(dctx, uctx->h_UnicodeError);
    dctx->h_UnicodeEncodeError = DHPy_open_context_constant(dctx, uctx->h_UnicodeEncodeError);
    dctx->h_UnicodeDecodeError = DHPy_open_context_constant(dctx, uctx->h_UnicodeDecodeError);
    dctx->h_UnicodeTranslateError = DHPy_open_context_constant(dctx, uctx->h_UnicodeTranslateError);
    dctx->h_ValueError = DHPy_open_context_constant(dctx, uctx->h_ValueError);
    dctx->h_ZeroDivisionError = DHPy_open_context_constant(dctx, uctx->h_ZeroDivisionError);
    dctx->h_BlockingIOError = DHPy_open_context_constant(dctx, uctx->h_BlockingIOError);
    dctx->h_BrokenPipeError = DHPy_open_context_constant(dctx, uctx->h_BrokenPipeError);
    dctx->h_ChildProcessError = DHPy_open_context_constant(dctx, uctx->h_ChildProcessError);
    dctx->h_ConnectionError = DHPy_open_context_constant(dctx, uctx->h_ConnectionError);
    dctx->h_ConnectionAbortedError = DHPy_open_context_constant(dctx, uctx->h_ConnectionAbortedError);
    dctx->h_ConnectionRefusedError = DHPy_open_context_constant(dctx, uctx->h_ConnectionRefusedError);
    dctx->h_ConnectionResetError = DHPy_open_context_constant(dctx, uctx->h_ConnectionResetError);
    dctx->h_FileExistsError = DHPy_open_context_constant(dctx, uctx->h_FileExistsError);
    dctx->h_FileNotFoundError = DHPy_open_context_constant(dctx, uctx->h_FileNotFoundError);
    dctx->h_InterruptedError = DHPy_open_context_constant(dctx, uctx->h_InterruptedError);
    dctx->h_IsADirectoryError = DHPy_open_context_constant(dctx, uctx->h_IsADirectoryError);
    dctx->h_NotADirectoryError = DHPy_open_context_constant(dctx, uctx->h_NotADirectoryError);
    dctx->h_PermissionError = DHPy_open_context_constant(dctx, uctx->h_PermissionError);
    dctx->h_ProcessLookupError = DHPy_open_context_constant(dctx, uctx->h_ProcessLookupError);
    dctx->h_TimeoutError = DHPy_open_context_constant(dctx, uctx->h_TimeoutError);
    dctx->h_Warning = DHPy_open_context_constant(dctx, uctx->h_Warning);
    dctx->h_UserWarning = DHPy_open_context_constant(dctx, uctx->h_UserWarning);
    dctx->h_DeprecationWarning = DHPy_open_context_constant(dctx, uctx->h_DeprecationWarning);
    dctx->h_PendingDeprecationWarning = DHPy_open_context_constant(dctx, uctx->h_PendingDeprecationWarning);
    dctx->h_SyntaxWarning = DHPy_open_context_constant(dctx, uctx->h_SyntaxWarning);
    dctx->h_RuntimeWarning = DHPy_open_context_constant(dctx, uctx->h_RuntimeWarning);
    dctx->h_FutureWarning = DHPy_open_context_constant(dctx, uctx->h_FutureWarning);
    dctx->h_ImportWarning = DHPy_open_context_constant(dctx, uctx->h_ImportWarning);
    dctx->h_UnicodeWarning = DHPy_open_context_constant(dctx, uctx->h_UnicodeWarning);
    dctx->h_BytesWarning = DHPy_open_context_constant(dctx, uctx->h_BytesWarning);
    dctx->h_ResourceWarning = DHPy_open_context_constant(dctx, uctx->h_ResourceWarning);
    dctx->h_BaseObjectType = DHPy_open_context_constant(dctx, uctx->h_BaseObjectType);
    dctx->h_TypeType = DHPy_open_context_constant(dctx, uctx->h_TypeType);
    dctx->h_BoolType = DHPy_open_context_constant(dctx, uctx->h_BoolType);
    dctx->h_LongType = DHPy_open_context_constant(dctx, uctx->h_LongType);
    dctx->h_FloatType = DHPy_open_context_constant(dctx, uctx->h_FloatType);
    dctx->h_UnicodeType = DHPy_open_context_constant(dctx, uctx->h_UnicodeType);
    dctx->h_TupleType = DHPy_open_context_constant(dctx, uctx->h_TupleType);
    dctx->h_ListType = DHPy_open_context_constant(dctx, uctx->h_ListType);
