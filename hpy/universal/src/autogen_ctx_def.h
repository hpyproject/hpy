...
struct _HPyContext_s global_ctx = {
    ...
    .ctx_Number_InPlaceAdd = &ctx_Number_InPlaceAdd,
    .ctx_Number_InPlaceSubtract = &ctx_Number_InPlaceSubtract,
    .ctx_Number_InPlaceMultiply = &ctx_Number_InPlaceMultiply,
    .ctx_Number_InPlaceMatrixMultiply = &ctx_Number_InPlaceMatrixMultiply,
    .ctx_Number_InPlaceFloorDivide = &ctx_Number_InPlaceFloorDivide,
    .ctx_Number_InPlaceTrueDivide = &ctx_Number_InPlaceTrueDivide,
    .ctx_Number_InPlaceRemainder = &ctx_Number_InPlaceRemainder,
    .ctx_Number_InPlacePower = &ctx_Number_InPlacePower,
    .ctx_Number_InPlaceLshift = &ctx_Number_InPlaceLshift,
    .ctx_Number_InPlaceRshift = &ctx_Number_InPlaceRshift,
    .ctx_Number_InPlaceAnd = &ctx_Number_InPlaceAnd,
    .ctx_Number_InPlaceXor = &ctx_Number_InPlaceXor,
    .ctx_Number_InPlaceOr = &ctx_Number_InPlaceOr,
