...
struct _HPyContext_s g_universal_ctx = {
    ...
    .ctx_UnicodeBuilder_New = &ctx_UnicodeBuilder_New,
    .ctx_UnicodeBuilder_Append = &ctx_UnicodeBuilder_Append,
    .ctx_UnicodeBuilder_Build = &ctx_UnicodeBuilder_Build,
    .ctx_UnicodeBuilder_Cancel = &ctx_UnicodeBuilder_Cancel,
