...
/* the main purpose of the macro is to turn "func" into "_func", which is the
   name of the trampoline generated by HPy_FUNCTION */
#define HPy_METHOD_DEF(name, func, flags, doc) {name, _##func, flags, doc}
